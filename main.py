...
if __name__=="__main__":
    ...
    if args.random:
        ...
        pose_dict = {'110': 1, '120': 2, '090': 3, '080': 4, '130': 5, '140': 6, '051': 7, '050': 8, '041': 9,
                         '190': 10, '200': 11, '010': 12, '240': 13, '081':5, '191':9}

        dataloader = get_loader(image_dir='/home/manager/jason/DR-GAN-11/data/session01/multiview', Np=13, Nd=250,

        dataloader = get_loader(image_dir='/home/home_data/jason/DR-GAN-11/data/session01/multiview', Np=13, Nd=250,
