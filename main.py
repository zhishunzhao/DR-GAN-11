...
if __name__=="__main__":
    ...
    if args.random:
        ...
        dataloader = get_loader(image_dir='/home/manager/jason/DR-GAN-11/data/session01/multiview', Np=13, Nd=250,pose_dict=pose_dict, image_size=110, batch_size=args.batch_size, mode='train',
                                num_workers=1)
        # print('test')
        # except:
